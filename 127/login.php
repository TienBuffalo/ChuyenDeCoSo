					...
					<div class="left-box">
						<form method="POST" action="validation.php" onsubmit="return validation()">
							<div class="form-group">
								<label><i class="fa fa-user fa-2x"></i>Tài khoản :</label>
								<input type="text" autocomplete="off" name="name" class="form-control" id="username" onkeypress="clear()">
							
								<label><i class="fa fa-lock fa-2x"></i>Mật khẩu :</label>
								...
								<button id="btn-login" type="submit">Đăng Nhập</button>
								
							</div>
							<div class="register">
								<h2>Không có tài khoản?&nbsp<span id="create-account"><a href="signup.php">Đăng ký</span></a> </h2>
							</div>
