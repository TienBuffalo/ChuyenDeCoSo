<?php 
  ...
  $profile=new users;               // creating the object of user class so that we can call show_user_profile() method 
  extract($_POST);
...
<!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../index.php">127 Math</a>
...
<!-- ========================================================================================================================== -->
  ...
  <div class="container mt-4 col-md-10 position-relative">
    <h3 style="font-family: 'Catamaran', sans-serif;">Xin chào <?php echo ucwords($_SESSION['username']); ?> , Bắt đầu làm nào</h3>
  ...
  <!-- tab content start -->
   ...
   <div class="tab-content">
     ...
     <center><button type="button" class="btn btn-success mt-5" href="#myid" data-toggle="collapse">Bắt Đầu</button></center>
