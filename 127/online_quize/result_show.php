...
<h2>Kết quả bài kiểm tra của bạn</h2><br>
 <table class="table table-bordered table-active">
  ...
  <tbody>
    <tr>
      <th scope="row">Tổng số câu trả lời</th>
      <td><?php echo $attempted_ques; ?></td>
     
    </tr>
    <tr>
      <th scope="row">Số câu trả lời đúng</th>
      <td> <?php echo $answers['right'];?></td>
      
    </tr>
    <tr>
      <th scope="row">Số câu trả lời sai</th>
      <td><?php echo $answers['wrong'];?></td>
  
    </tr>

      <tr>
      <th scope="row">Tổng số câu không trả lời</th>
