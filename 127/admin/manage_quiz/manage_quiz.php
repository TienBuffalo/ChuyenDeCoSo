...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;height:800px;" id="sidebar" >
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#manage_course">Thêm bài trắc nghiệm</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#menu2">Thêm mới câu hỏi</a>
  </li>
</ul>
		<!-- Nav tabs ends -->
