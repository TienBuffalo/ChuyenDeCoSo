...
background: linear-gradient(to right, #F3A183, #EC6F66); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
  ...
  <a class="navbar-brand text-white" href="#">127 Math</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      <li class="nav-item active">
        <a class="nav-link text-white" href="#">TRANG CHỦ <span class="sr-only">(current)</span></a>
      </li>
      ...
      <div class="row">
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            <li class="list-group-item  bg-dark "><a href="">Xin chào Admin</a></li>
            <li class="list-group-item bg-dark "><a href="manage_courses/manage_courses.php">CHƯƠNG TRÌNH HỌC</a></li>
            <li class="list-group-item bg-dark"><a href="manage_quiz/manage_quiz.php">BÀI TRẮC NGHIỆM</a></li>
            <li class="list-group-item bg-dark"><a href="manage_videos/manage_videos.php">VIDEO BÀI GIẢNG</a></li>
            <li class="list-group-item bg-dark"><a href="">Hỗ trợ</a></li>
        ...
        <div class=" col-md-10">
               <div class="card-header bg-white" style="margin-right: -45px; height: 60px;">
                 <b>BẢNG ĐIỀU KHIỂN</b>
                  <button type="btn btn-outline-success" class="btn btn-primary float-right" style="height: 40px;"><a href="../login.php" class="text-white ">ĐĂNG XUẤT</a> </button>
                  </div>
                 <div class="row">
          ...
          <div class="col-md-4 mt-3 ml-5">
            <div class="card shadow " style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
              ...
              <div class="card-body">
                <p class="card-text"><a href="manage_courses/manage_courses.php" style="text-decoration: none;">CHƯƠNG TRÌNH HỌC <i class="fa fa-book ml-3"></i></a></p>
              </div>
            </div>
           ...
           <div class="col-md-4 mt-3">
            <div class="card shadow" style="width: 18rem;cursor:pointer; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
              ...
              <div class="card-body">
                <p class="card-text "><a href="manage_videos/manage_videos.php" style="text-decoration: none; color: orangered">VIDEOS BÀI GIẢNG</a><i class="fa fa-video-camera ml-3" style="color: orangered"></i></p>
              </div>
            </div>
      ...
      <tr>
        <td class="mytable1">
           <div class="card shadow border-0 " style="width: 15rem; height: 110px; box-shadow: 2px 3px #827171; border-radius:0px; border-top-left-radius: 0px;">
              ...
              <div class="card-body">
                <p class="card-text text-white"><b class="h4">CHƯƠNG TRÌNH HỌC </b><br><span style="font-size: 20px;"><?php $admin->display_course_count(); ?></span></p>
              </div>
            </div>
      ...
      <tr>
        <td class="mytable2">
           <div class="card shadow border-0" style="width: 15rem; height: 110px; box-shadow: 2px 2px #827171; border-radius:0px; border-top-left-radius: 0px;">
             ...
             <div class="card-body">
                <p class="card-text text-white"><b class="h4">VIDEO BÀI GIẢNG</b><br><span style="font-size: 20px;"><?php $admin->display_video_count(); ?></span></p>
              </div>
            ...
            <div class="row ">     <!--  second row closed -->
              ...
              <div class="col-md-8">    <!-- list of users starts -->
                ...
                <p class="ml-5">DANH SÁCH NGƯỜI DÙNG</p>
                <thead>
                  <tr>
           ...
           <div class="col-md-3 mt-5 ml-5">
            <div class="card shadow" style="width: 15rem; height:22rem; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
              ...
              <div class="card-body">
                <p class="card-text "><a href="manage_quiz/manage_quiz.php" style="text-decoration: none; color: orangered">BÀI TRẮC NGHIỆM</a></p>
              </div>
            </div>
